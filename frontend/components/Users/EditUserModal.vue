              ...
              <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                ...
                <div class="mt-4 space-y-4">
                  ...
                  <div>
                    ...
                    <input id="edit-name" ref="firstNameInput" v-model="form.name" type="text" required
                  ...
                  <div>
                    ...
                    <input id="edit-last-name" v-model="form.last_name" type="text" required
                      class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                      :class="{
                        'border-red-300 focus:ring-red-500 focus:border-red-500':
                          errors.last_name,
                      }" placeholder="Enter last name" />
                    <p v-if="errors.last_name" class="mt-1 text-sm text-red-600" role="alert">
                      {{ errors.last_name[0] }}
                    </p>
                  </div>
                  ...
                  <div v-if="form.password && form.password.trim() !== ''">
                    ...
                    <input id="edit-password-confirmation" v-model="form.password_confirmation" type="password" required
                      class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                      :class="{
                        'border-red-300 focus:ring-red-500 focus:border-red-500':
                          errors.password_confirmation,
                      }" placeholder="Confirm new password" />
                    <p v-if="errors.password_confirmation" class="mt-1 text-sm text-red-600" role="alert">
                  ...
                  <div>
                    ...
                    <p v-if="errors.role" class="mt-1 text-sm text-red-600" role="alert">
                      {{ errors.role[0] }}
                    </p>
                  </div>
                </div>
